...
Repositório de provas antigas da Disciplina **Empreendedorismo e Ética** do curso de **Tecnologia em Sistemas de Computaćao** da **UFF** ministrado através do **CEDERJ**.
...
`git clone https://github.com/compcederj/empreendedorismo-e-etica.git`
...
`git clone git@github.com:compcederj/empreendedorismo-e-etica.git`
...
# Empreendedorismo e Ética
Repositório de provas antingas da Disciplina **Empreendedorismo e Ética** do curso de **Tecnologia em Sistemas de Computaçao** da **UFF** ministrado através do **CEDERJ**.
